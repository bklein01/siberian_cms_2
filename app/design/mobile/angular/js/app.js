...
App.run(function($rootScope, $window, $route, $location, $timeout, $templateCache, Connection, Customer, Application, Padlock, Message, $http, AUTH_EVENTS, Url, LayoutService, Translator) {
