...
//    public function findlastpushAction() {
//        $data = array();
//        if($device_uid = $this->getRequest()->getParam('device_uid')) {
//            $message = new Push_Model_Message();
//            $last_push = $message->findLastPushMessage($device_uid);
//
//            if($last_push->getMessageId()) {
//                Zend_Debug::dump("last push)");
//                die(__METHOD__ . " L:" . __LINE__);
//
//                $data = array(
//                    "title" => $last_push->getTitle(),
//                    "text" => $last_push->getText(),
//                    "cover" => $last_push->getCoverUrl()
//                );
//            }
//        }
//        $this->_sendHtml($data);
