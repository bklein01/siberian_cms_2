    ...
    public function preDispatch() {
        $this->_xml_files = array(
            "android-app.xml" => array(
                ...
                "base_path" => Core_Model_Directory::getBasePathTo("var".DS."apps".DS."android".DS."Siberian".DS."app".DS."src".DS."main".DS."res".DS."values".DS),
                "user_path" => Core_Model_Directory::getBasePathTo("var".DS."apps".DS."android".DS."Siberian".DS."app".DS."src".DS."main".DS."res".DS),
            ...
            "android-previewer.xml" => array(
                ...
                "base_path" => Core_Model_Directory::getBasePathTo("var".DS."apps".DS."android".DS."previewer".DS."app".DS."src".DS."main".DS."res".DS."values".DS),
                "user_path" => Core_Model_Directory::getBasePathTo("var".DS."apps".DS."android".DS."previewer".DS."app".DS."src".DS."main".DS."res".DS),
                "file_name" => "strings.xml",
                "info" => $this->_("Translate the 'e.g.' between parentheses only.")
            ),
        );
