...
//            $this->_baseDefaultLayout = simplexml_load_file(Core_Model_Directory::getDesignPath(true) . '/layout/front.xml', null, LIBXML_COMPACT);
            $this->_baseDefaultLayout = new SimpleXMLElement(file_get_contents(Core_Model_Directory::getDesignPath(true) . '/layout/front.xml'));
...
//            $this->_baseActionLayout = simplexml_load_file(Core_Model_Directory::getDesignPath(true) . '/layout/'.$filename);
            $this->_baseActionLayout = new SimpleXMLElement(file_get_contents(Core_Model_Directory::getDesignPath(true) . '/layout/'.$filename));
