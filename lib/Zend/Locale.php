...
class Zend_Locale
{
    ...
    private static $_localeData = array(
        ...
        'pt_BR' => true, 'pt_MZ' => true, 'pt_PT' => true, 'pt'    => true, 'ro_MD' => true,
        'ro_RO' => true, 'ro'    => true, 'ru_RU' => true, 'ru_UA' => true, 'ru'    => true,
        'rw_RW' => true, 'rw'    => true, 'sa_IN' => true, 'sa'    => true, 'se_FI' => true,
        'se_NO' => true, 'se'    => true, 'sh_BA' => true, 'sh_CS' => true, 'sh_YU' => true,
        'sh'    => true, 'si_LK' => true, 'si'    => true, 'sid_ET'=> true, 'sid'   => true,
        'sk_SK' => true, 'sk'    => true, 'sl_SI' => true, 'sl'    => true, 'so_DJ' => true,
        'so_ET' => true, 'so_KE' => true, 'so_SO' => true, 'so'    => true, 'sq_AL' => true,
        'sq'    => true, 'sr_BA' => true, 'sr_CS' => true, 'sr_ME' => true, 'sr_RS' => true,
        'sr_YU' => true, 'sr'    => true, 'ss_SZ' => true, 'ss_ZA' => true, 'ss'    => true,
        'st_LS' => true, 'st_ZA' => true, 'st'    => true, 'sv_FI' => true, 'sv_SE' => true,
        'sv'    => true, 'sw_KE' => true, 'sw_TZ' => true, 'sw'    => true, 'syr_SY'=> true,
        'syr'   => true, 'ta_IN' => true, 'ta'    => true, 'te_IN' => true, 'te'    => true,
        'tg_TJ' => true, 'tg'    => true, 'th_TH' => true, 'th'    => true, 'ti_ER' => true,
        'ti_ET' => true, 'ti'    => true, 'tig_ER'=> true, 'tig'   => true, 'tl'    => true,
        'tn_ZA' => true, 'tn'    => true, 'to_TO' => true, 'to'    => true, 'tr_TR' => true,
        'tr'    => true, 'trv_TW'=> true, 'trv'   => true, 'ts_ZA' => true, 'ts'    => true,
        'tt_RU' => true, 'tt'    => true, 'ug_CN' => true, 'ug'    => true, 'uk_UA' => true,
        'uk'    => true, 'ur_IN' => true, 'ur_PK' => true, 'ur'    => true, 'uz_AF' => true,
        'uz_UZ' => true, 'uz'    => true, 've_ZA' => true, 've'    => true, 'vi_VN' => true,
        'vi'    => true, 'wal_ET'=> true, 'wal'   => true, 'wo_SN' => true, 'wo'    => true,
    ...
    private static $_territoryData = array(
        ...
        'CL' => 'es_CL', 'CM' => 'fr_CM', 'CN' => 'zh_CN', 'CO' => 'es_CO', 'CR' => 'es_CR',
        ...
        'ER' => 'ti_ER', 'ES' => 'es_ES', 'ET' => 'aa_ET', 'FI' => 'fi_FI', 'FJ' => 'hi_FJ',
        ...
        'GU' => 'en_GU', 'GW' => 'pt_GW', 'GY' => 'en_GY', 'HK' => 'zh_HK', 'HM' => 'und_HM',
        ...
        'KR' => 'ko_KR', 'KW' => 'ar_KW', 'KY' => 'en_KY', 'KZ' => 'kk_KZ', 'LA' => 'lo_LA',
        ...
        'NE' => 'ha_Latn_NE', 'NF' => 'en_NF', 'NG' => 'ig_NG', 'NI' => 'es_NI', 'NL' => 'nl_NL',
        ...
        'TO' => 'to_TO', 'TR' => 'tr_TR', 'TT' => 'en_TT', 'TV' => 'tvl_TV', 'TW' => 'zh_TW',
